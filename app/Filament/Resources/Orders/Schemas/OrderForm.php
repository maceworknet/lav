            ...
            ->components([
                Tabs::make('Sipariş')
                    ...
                    ->tabs([
                                        ...
                                        Grid::make(3)
                                            ->schema([
                                                ...
                                                Select::make('status')
                                                    ...
                                                    ->required()
                                                    ->helperText('Durum değişince müşteriye otomatik bildirim/mail gönderilir.'),
                        ...
                        Tab::make('Teslimat ve Kart Notu')
